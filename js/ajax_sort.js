jQuery(document).ready(function($){
    ...
    $(".product_check").click(function(){
        ...
        $.ajax({
            url:'action.php',
            method:'POST',
            data:{action:action, brand:brand, price:price, demand:demand, cpu:cpu, ram:ram, hard_drive:hard_drive, vga:vga, dvdrw:dvdrw, screen_hd:screen_hd, screen_hz:screen_hz, os:os, insurance:insurance, page: page},
