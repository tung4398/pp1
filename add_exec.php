...
<body>
	...
	<div class="exec__result wrapper">
		<div>
			<h1>Kết quả thêm thông tin sản phẩm</h1>
			<br/>
				<p>Bạn đã thêm dữ liệu sản phẩm thành công, bạn muốn thực hiện <a href="add.php">thêm mới</a> hay quay về <a href="search.php">danh sách sản phẩm</a></p>
			<br/>
		</div>
